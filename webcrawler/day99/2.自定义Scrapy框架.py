...
class ChoutiSpider(object):
    ...
    def start_requests(self):
        start_url = ['http://www.baidu.com','http://www.bing.com',"http://www.cnblogs.com",
                     "https://blog.csdn.net/","https://www.liaoxuefeng.com"]
...
class Engine(object):
    ...
    def _next_request(self):
        ...
        :return:
        """
        print("crwaling:",self.crawlling.__len__()," Q:",Q.qsize())
        self.n += 1
        ...
        if len(self.crawlling) >= self.max:
            print("我在第",self.n,"次执行方法时return了")
            return
    ...
    def crawl(self,spider):
        ...
        self._close = defer.Deferred()  #作用是让reactor hang住
        yield self._close
